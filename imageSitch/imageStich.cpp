...
int main(int argc, char** argv)
{
    ...
    img = imread("/home/byiwind/OpenCV/opencv_example-master/imageSitch/pic/l.jpg");
 //   resize(img, img, Size(), 0.5, 0.5);
    imgs.push_back(img);

    img = imread("/home/byiwind/OpenCV/opencv_example-master/imageSitch/pic/r.jpg");
//    resize(img, img, Size(), 0.5, 0.5);
    imgs.push_back(img);

//    img = imread("/home/byiwind/OpenCV/opencv_example-master/imageSitch/00/total/2.jpg");
//    resize(img, img, Size(), 0.5, 0.5);
//    imgs.push_back(img);
//
//    img = imread("/home/byiwind/OpenCV/opencv_example-master/imageSitch/00/total/3.jpg");
//    resize(img, img, Size(), 0.5, 0.5);
//    imgs.push_back(img);
//
//    img = imread("/home/byiwind/OpenCV/opencv_example-master/imageSitch/00/total/4.jpg");
//    resize(img, img, Size(), 0.5, 0.5);
//    imgs.push_back(img);
//
//    img = imread("/home/byiwind/OpenCV/opencv_example-master/imageSitch/00/total/5.jpg");
//    resize(img, img, Size(), 0.5, 0.5);
//    imgs.push_back(img);
//
//    img = imread("/home/byiwind/OpenCV/opencv_example-master/imageSitch/00/total/6.jpg");
//    resize(img, img, Size(), 0.5, 0.5);
//    imgs.push_back(img);
//
//    img = imread("/home/byiwind/OpenCV/opencv_example-master/imageSitch/00/total/7.jpg");
//    resize(img, img, Size(), 0.5, 0.5);
//    imgs.push_back(img);
...
//    fb->setSharpness(0.005);    //设置羽化锐度
    ...
    imwrite("/home/byiwind/OpenCV/opencv_example-master/imageSitch/00/total/result.jpg", result);    //存储全景图像
